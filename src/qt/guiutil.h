...
/** Utility functions used by the Deflacash Qt UI.
 */
namespace GUIUtil
{
...
// Render Deflacash addresses in monospace font
...
// Parse "deflacash:" URI into recipient object, return true on successful parsing
