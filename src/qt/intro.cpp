...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Deflacash Core"),
     ...
     * override -datadir in the deflacash.conf file in the default data directory
     * (to be consistent with deflacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
