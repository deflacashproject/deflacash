                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Deflacash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Deflacash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and deflacash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Deflacash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Deflacash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Deflacash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Deflacash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Deflacash addresses"));
    ...
    openAction->setStatusTip(tr("Open a Deflacash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Deflacash Core help message to get a list with possible Deflacash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Deflacash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Deflacash network", "", count));
}
...
{
    QString strTitle = tr("Deflacash Core"); // default title
