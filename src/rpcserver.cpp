...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Deflacash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Deflacash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Deflacash features */
        {"deflacash", "masternode", &masternode, true, true, false},
        {"deflacash", "masternodelist", &masternodelist, true, true, false},
        {"deflacash", "mnbudget", &mnbudget, true, true, false},
        {"deflacash", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"deflacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"deflacash", "mnsync", &mnsync, true, true, false},
        {"deflacash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"deflacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use deflacashd, or the -server option to deflacash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> deflacash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17211/\n";
}
