...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Deflacash Core deflacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  deflacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded deflacash transaction") + "\n" +
                               "  deflacash-tx [options] -create [commands]   " + _("Create hex-encoded deflacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded deflacash transaction
