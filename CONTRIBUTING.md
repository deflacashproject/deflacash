Contributing to Deflacash Core
============================

The Deflacash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Deflacash Core project, and is not to be
confused with overall Deflacash Network Protocol consensus changes.

Whether a pull request is merged into Deflacash Core rests with the project merge
...
Patches that change Deflacash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Deflacash consensus, it must have been
...
The project leader is the release manager for each Deflacash Core release.
