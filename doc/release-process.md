...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/deflacash/deflacash/blob/master/doc/translation_process.md#synchronising-translations).
...
- Detached signatures will then be committed to the [deflacash-detached-sigs](https://github.com/deflacash/deflacash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/deflacash/deflacash/releases/new) with a link to the archived release notes.
