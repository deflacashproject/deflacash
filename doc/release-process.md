...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/deflacashproject/deflacash/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign Deflacash Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit deflacash=v${VERSION} ../deflacash/contrib/gitian-descriptors/gitian-win.yml
...
- Detached signatures will then be committed to the [deflacash-detached-sigs](https://github.com/deflacashproject/deflacash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/deflacashproject/deflacash/releases/new) with a link to the archived release notes.
