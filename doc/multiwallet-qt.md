...
In order to support loading of multiple wallets in deflacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is deflacash.cpp.
...
Changes to deflacash.cpp
----------------------
deflacash.cpp is the entry point into deflacash-qt, and as such, will require some minor modifications to provide hooks for
