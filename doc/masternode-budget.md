...
Deflacash now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<deflacash_address\> \<monthly_payment_deflacash\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Deflacash, _12_ times over the course of a year totaling _24000_ Deflacash.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<deflacash_address\> \<monthly_payment_deflacash\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Deflacash.
 ...
 * vote-many          - Vote on a Deflacash initiative
 * vote-alias         - Vote on a Deflacash initiative
 * vote               - Vote on a Deflacash initiative/budget
