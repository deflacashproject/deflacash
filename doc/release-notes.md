Deflacash Core version 2.2.1 is now available from:
  ...
  <https://github.com/deflacashproject/deflacash/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/deflacashproject/deflacash/issues>

Compatibility
==============

Deflacash Core is extensively tested on multiple operating systems using
...
Deflacash Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Deflacash was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/deflacash-project-translations/).
